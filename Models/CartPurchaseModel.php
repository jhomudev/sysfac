...
class CartPurchaseModel extends MainModel
{
  ...
  protected static function addItemModel(int $product_id, string $serial_number, string $name, float $price, int $quantity, int $profit): bool
  {
    $item = [
      ...
      "quantity" => $quantity,
      "price" => $price,
      "price_sale" => $price + ($profit / 100 * $price),
