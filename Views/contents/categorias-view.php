...
<div class="modal" id="modalForm">
  <form action="<?php echo SERVER_URL; ?>/fetch/formCategoryFetch.php" method="POST" class="form form__create formFetch">
    ...
    <fieldset class="form__group">
      ...
      <input type="text" class="form__input" id="nombreCategoria" name="tx_nombre">
    </fieldset>
    <fieldset class="form__group">
