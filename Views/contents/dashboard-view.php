        ...
        <ul class="movs__ul">
          ...
          if (count($movements) > 0) {
            foreach ($movements as $movement) {
              ...
              if ($diff_minutes < 60 && $diff_minutes < 1) $time_elapsed = "Hace un momento";
              else if ($diff_minutes < 60 && $diff_minutes >= 1) {
