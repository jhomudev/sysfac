<div class="menuBar">
  ...
  <nav class="nav">
    ...
    <div class="logout">
      <a data-content="Cerrar sesión" class="nav__link btnLogout"><i class="ph ph-sign-out"></i><span>Cerrar sesión</span></a>
    </div>
  </nav>
</div>
...
<div class="menuBar__responsive" id="menuBarResponsive">
  ...
  <nav class="nav">
    <ul>
      ...
      <li>
        <a href="<?php echo SERVER_URL; ?>/almacenes" data-view="almacenes" class="res__nav__link nav_item_link"><i class="ph ph-warehouse"></i><span>Almacenes</span></a>
      </li>
    </ul>
    <div class="logout">
      <a class="res__nav__link btnLogout"><i class="ph ph-sign-out"></i><span>Cerrar sesión</span></a>
    </div>
  </nav>
</div>